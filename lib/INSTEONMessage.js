...
=======
	...
	Object.defineProperty(this, "from", {
		set: function(value){
			return from = (Buffer.isBuffer(value) || Array.isArray(value)) ? new Buffer(value) : new Buffer(3);
>>>>>>> 29337fb143667f666387bc3af9bbf10de7b253bc
		},
		get: function(){
			return from;
		}
	...
	if(Buffer.isBuffer(message) || Array.isArray(message)){
		...
		from = parsed.from;
		Buffer.call(this, new INSTEONMessage(parsed));
	}else{
		this.flags = message.flags;
		Buffer.call(this, (this.extended ? 20 : 6));
		from = message.from || new Buffer(3);
		this.to = message.to;
...
INSTEONMessage.prototype = new Buffer(0);
