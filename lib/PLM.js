...
PLM.prototype.sendINSTEON = function(message, cb, jump){
	var self = this;
...
PLM.prototype.sendINSTEONNow = function(message, cb){
	var self = this;
	...
	this.sendCommand(data, function(err, data, cmdnum){
		if(err){
...
PLM.prototype.INSTEONDequeue = function(){
	var self = this;
	if(this.INSTEONBusy){
		return false;
	}
	...
	this.sendINSTEONNow(cmd.message, cmd.callback);
